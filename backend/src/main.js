...
function getAllowedOrigins() {
    var configured = process.env.CORS_ORIGIN
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.enableCors({
                        origin: function (origin, callback) {
                            ...
                            var isExactMatch = allowedOrigins.includes(origin);
                            var isVercelPreview = process.env.ALLOW_VERCEL_PREVIEWS === 'true' &&
                ...
                case 2:
                    ...
                    console.log("\uD83D\uDE80 QR Code Generator API running on http://localhost:".concat(port));
                    return [2 /*return*/];
            }
        });
    });
