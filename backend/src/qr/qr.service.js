...
var QrService = function () {
    ...
    var QrService = _classThis = /** @class */ (function () {
        function QrService_1() {
        }
        /**
         * Generates a QR code for the given URL and returns it as a
         * Base64-encoded PNG data URL.
         */
        QrService_1.prototype.generateQrCode = function (url) {
            return __awaiter(this, void 0, void 0, function () {
                var qrCodeDataUrl, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, qrCodeDataUrl];
                        case 2:
                            error_1 = _a.sent();
                            throw new common_1.BadRequestException('Failed to generate QR Code. Please try again.');
